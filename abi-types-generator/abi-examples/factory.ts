export interface CallOptions {
    ...
    export interface MethodPayableReturnContext {
        ...
        callback: (error: Error, result: TCallReturn) => void
    ...
    }export interface MethodReturnContext extends MethodPayableReturnContext {}export enum AbiEvents {NewExchange = "NewExchange",}export interface EventsContext {NewExchange(parameters: 
         {
         ...
         ): any;}export enum FactoryAbiMethodNames {initializeFactory = "initializeFactory",createExchange = "createExchange",getExchange = "getExchange",getToken = "getToken",getTokenWithId = "getTokenWithId",exchangeTemplate = "exchangeTemplate",tokenCount = "tokenCount",}
